! function() {
  ...
  define([
    ...
    'Components/Custom/toggle-group',
    'Components/Basic/repeater',
    'Components/Custom/row',
    'Components/Basic/radio-group',
    'text!Pages/App/app.html',
    'text!Pages/App/table.html'
  ], function(Backbone, $, ComponentView, TextComponent, ButtonComponent, ToggleComponent, ComponentRepeater, RowComponent, RadioGroupComponent, AppTpl, TableTpl) {
